...
{
    public class XROMService: IDbService 
    {
        private string _connectionString = "";
        private DatabaseType _dataBaseType;
        public XROMService(string connectionString, DatabaseType dataBaseType) {
        ...
        public ZJTransaction CreateTransaction()
        {
            ...
            zJTransaction.OrmTransation = new OrmTransation(OrmTransactionLevel.ReadCommitted, _connectionString);
